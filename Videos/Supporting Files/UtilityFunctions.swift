...
/*
**************************
MARK: Get UIImage from URL
**************************
*/
public func getUIImageFromUrl(url: String, defaultFilename: String) -> UIImage {
    /*
     If getting UIImage from URL fails, Image file with given defaultFilename
     (e.g., "ImageUnavailable") in Assets.xcassets will be returned as UIImage.
     */
